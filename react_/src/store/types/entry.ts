...
export interface IConfigData {
  ...
  Web_Set_DefaultInfo: IWebSetDefaultInfo | Record<string, unknown>
  Web_Set_WebReg: IWebSetWebReg | Record<string, unknown>
  ...
  Web_Transfer_BuySell_Coin_Fee: IWebTransferBuySellCoinFee | Record<string, unknown>
