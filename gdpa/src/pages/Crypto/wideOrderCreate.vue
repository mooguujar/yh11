<template>
  <div class="orderCreate relative van-safe-area-botton !pb-[0] orderCreatewide van-safe-area-top">
    ...
    <div
      v-if="!getShowLoading"
      class="wideOrderCreatePath overflow_a"
    >
      <div
        class="top_wrop"
      ...
      <div class="FcontentWrap px-[0px] gd_buy_fixmomey">
        <!-- :class="isiOS ? 'pb-[75px]' : ''" -->
        <div class="clearfix">
          <!-- 左边的 -->
          <div
            class="Fcontent van-safe-area-bottom !pr-[9px] left"
            :class="[2, 4, 5, 8].includes(BuyOrderDetail.status) ? '!w-[100%] !pr-[20px]' : ''"
          >
            <div
            ...
            >
              <!-- 改的金额 -->
              <div
                class="fixmoney h-[98px]"
                v-if="gd_buy_fixmomey == 1"
              >
                <p class="text-[48px] text-[red] text-center">
                  <span class="!my-[0] !text-[#000] text-[28px]">订单金额 ：</span>
                  {{
                    (+BuyOrderDetail.buy_num).toFixed(2) ||
                    (+BuyOrderDetail.remaining_num).toFixed(2)
                  }}
                ...
                <p class="text-center text-[#000] text-[25px] mt-[10px]">
                  <span class="!my-[0] !text-[#000]">订单号 ：</span>
              ...
              <div
                ...
                v-if="!SellOrder && [2, 4, 5, 8].includes(BuyOrderDetail.status)"
              >
                <div class="O_num">
                  订单状态
                  <span class="O_nums">
              ...
              >
                <div class="px-[15px]">
                  ...
                  >
                    ...
                    <span class="payTitle">
                      银行卡支付
                      <span class="text-[red]">支持 支付宝/网银/微信</span>
                    </span>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <van-image
                        ...
                        lazy-load
                        @click="
                          pay_pic_BG ? (pay_pic_BG_dialog = true) : showImagePreview([pay_pic])
                        "
                        :src="pay_pic"
                      />
                    </div>
          ...
          <!-- right -->
          <div class="Fcontent right !pl-[9px] gd_buy_fixmomey">
            <!-- 下方小文字提示 -->
            <div
              v-if="!SellOrder && ![2, 4, 5, 8].includes(BuyOrderDetail.status)"
              class="h-[98px]"
            ...
            >
              ...
              >
                <div class="mt-[10px] h-[50px] pb-[20px] leading-[50px] my-[10px]">
                  <van-field
                    ...
                    :class="{
                      unboder:
                        !!pay_realname || [7, 6, 8].includes(BuyOrderDetail.status)
                          ? 'unboder'
                          : '',
        ...
        <div class="orderButtonWrap mt-[30px]">
          ...
          >
            <van-button
              ...
              class="orderOperation !bg-[#fff] bor_primary !text-[var(--van-button-primary-background)]"
            >
              {{ '联系客服' }}
            </van-button>
            <div
          ...
          取消挂单
            ...
            <van-button
              ...
              "
              class="orderOperation paidButton"
              @click="
    ...
    <van-dialog
      ...
      class="confirm-dialog bg-[rgba(0,0,0,0)] max-h-[700px] top-[150px]"
      title=""
      theme="round-button"
    ...
    >
      ...
      <div class="p-[40px] text-center pay_pic_BG flex_sz !h-[600px] !w-[385.8px]">
        <van-image
          class="payImg img_position1 !w-[250px] !top-[30px]"
          lazy-load
          :src="pay_pic"
        />
      </div>
...
const gd_buy_fixmomey = ref(search.get('gd_buy_fixmomey') || 1)
...
const getSellOrderDetail = () => {
  return SellOrderDetail({ order_id: query.order_id as string }).then(data => {
...
const getBuyOrderDetail = (order_id: string) => {
  ...
  // setTimeout(() => {
  return apiBuyOrderDetail({ order_id: order_id || (query.order_id as string) }).then(data => {
...
const getBuySellData = async () => {
  ...
  query && SellOrder.value
    ? await getSellOrderDetail()
    : await getBuyOrderDetail(query.order_id as string)
